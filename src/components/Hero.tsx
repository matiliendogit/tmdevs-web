    ...
    >
      ...
      <div className="flex flex-col items-center text-center px-6 relative z-10">
        ...
        <div
          ...
          style={{ animation: "heroLineExpand 0.8s ease 0.55s both" }}
        />
        ...
        <p
          ...
          style={{ animation: "heroFadeUp 0.7s ease 0.75s both" }}
        >
        ...
        <p
          ...
          style={{ animation: "heroFadeUp 0.7s ease 0.95s both" }}
        >
        ...
        <a
          ...
          style={{ animation: "heroFadeUp 1.4s ease 1.2s both" }}
